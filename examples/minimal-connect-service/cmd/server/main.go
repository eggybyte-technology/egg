...
//
//	Or from cmd/server directory:
//	  cd cmd/server && go run main.go
//
//	Build and run (from project root):
//	  go build -o bin/greet-service ./cmd/server
//	  ./bin/greet-service
//
//	Configure via environment:
//	  SERVICE_NAME=greet HTTP_PORT=8080 ./bin/greet-service
//
// Endpoints:
...
func main() {
	...
	err := servicex.Run(ctx,
		...
		servicex.WithMetricsConfig(true, true, false, false), // Enable runtime and process metrics
